...
class ConvolutionalNeuralNetworkTrainer(BaseTrainer):
    ...
    def test(self):
        tf.logging.info("Accuracy:", model.accuracy.eval(
            {model.X: self.mnist.test.images, model.y: self.mnist.test.labels, model.is_training: False}))
